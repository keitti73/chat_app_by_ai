...
- **[Terraform運用ガイド.md](./guides/Terraform運用ガイド.md)** - 🏗️ インフラ運用ベストプラクティス（🆕）
- **[デプロイメント動作確認ガイド.md](./guides/デプロイメント動作確認ガイド.md)** - デプロイ手順確認 AppSync×DynamoDB リアルタイムチャットアプリの詳細ドキュメントが整理されています。

## 🆕 **最新更新情報**
- **Terraform最適化完了**: ファイル分割戦略とリソース最適化 ✅
- **セキュリティ強化**: IAM最小権限・暗号化・監視システム ✅
- **運用ガイド**: 包括的なベストプラクティス ✅
- **アーキテクチャ更新**: 最適化後の構成図追加 ✅
...
- **[システムアーキテクチャ図集.md](./architecture/システムアーキテクチャ図集.md)** - 各種アーキテクチャ図（最適化版）
- **[システム処理フロー詳細解説.md](./architecture/システム処理フロー詳細解説.md)** - 処理フローの詳細
- **[Terraform最適化完了レポート.md](./architecture/Terraform最適化完了レポート.md)** - 🏗️ インフラ最適化実施レポート（🆕）
